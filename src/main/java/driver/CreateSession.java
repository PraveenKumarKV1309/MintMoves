...
public class CreateSession {
	...
	//private static final Logger logger = (Logger) LogManager.getLogger(CreateSession.class);
	...
	/** 
	 * this method starts properties file.
	 * @throws Exception Unable to start get property
	 */
	...
	public void androidDriver() throws MalformedURLException{
		...
		//	File fileReader=new File("E:\\Mahesh\\Automation\\workspace\\MoveMint\\src\\test\\resources\\app\\ApiDemos.apk");
			...
			capabilities.setCapability(MobileCapabilityType.UDID,"ca15f7c6");
